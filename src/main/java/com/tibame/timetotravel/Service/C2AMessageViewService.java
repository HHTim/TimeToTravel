...
public interface C2AMessageViewService {
    List<C2AMsgView> findViewByPage(Integer currPage, Integer row);
    ...
    List<C2AMsgView>findViewByKeyWordsPage(String keyword, Integer currPage, Integer limit);
    PageBean<C2AMsgView>findBeanPageViewByKeyWords(String keyword, Integer currPage, Integer limit);
