...
VALUES
(1, '菜頭', 50, 100, 1, '冷凍食品', '好吃的菜頭', 'Null'),
(2, '榴槤冰棒', 80, 50, 1, '彌月食品', '貓山王牌', 'Null'),
(1, '芒果冰', 60, 200, 1, '熱門美食', '愛文芒果', 'Null'),
(3, '草莓醬', 70, 80, 1, '熱門美食', '大湖特產', 'Null'),
(2, '梅子酒', 90, 120, 1, '冷凍食品', '梅子釀酒', 'Null'),
(3, '清酒', 65, 150, 1, '團購美食', '米釀成酒', 'Null'),
(1, '威士忌', 55, 80, 1, '熱門美食', '這是土產G的介紹', 'Null'),
(2, '貓罐頭', 75, 100, 1, '冷凍食品', '這是土產H的介紹', 'Null'),
(3, '香氛蠟燭', 95, 60, 1, '熱門美食', '這是土產I的介紹', 'Null'),
(1, '檳榔', 70, 90, 1, '冷凍食品', '這是土產J的介紹', 'Null');